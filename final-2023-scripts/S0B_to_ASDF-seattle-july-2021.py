...
# data/file paths
#rootpath = '/mnt/data0/SEATTLE_NODES_DATA'
#RAWDATA='/mnt/data0/SEATTLE_NODES_DATA/DATA/NODES_IRIS_MSEED/select_7nodes_for_cross_corr_with_UW_BST'
#locations='/mnt/data0/SEATTLE_NODES_DATA/resp_7nodes_station.txt'
#DATADIR = '/mnt/data0/UW_xiaotao_7nodes/RAW_DATA'

rootpath = '/mnt/data1/SEATTLE_June-2021_studies/'
RAWDATA='/mnt/data0/SEATTLE_NODES_DATA--2019/DATA/NODES_IRIS_MSEED
#RAWDATA='/mnt/data0/SEATTLE_NODES_DATA/JUNE_2021_studies/NODES_mseed_data_downsampled_20_Hz'
DATADIR='/mnt/data0/SEATTLE_NODES_DATA/JUNE_2021_studies/NODES_asdf_data_40_Hz'
#DATADIR='/mnt/data0/SEATTLE_NODES_DATA/JUNE_2021_studies/NODES_asdf_data_20_Hz_May-2022'
locations = os.path.join(rootpath,'station.txt')

#DATADIR   = os.path.join(rootpath,'ASDF_DATA_remove_resp_MERI')      # dir where cleaned data in ASDF format are going to be outputted

#rootpath = '/mnt/data1/CAUCASUS_XA_DATA_hydro'
#RAWDATA = os.path.join(rootpath,'mseed_autumn')
#DATADIR   = os.path.join(rootpath,'ASDF_autumn')
#locations = os.path.join(rootpath,'station_caucasus.txt')

#RAWDATA   = '/mnt/data0/seattle_broadbands_2019/RAW_DATA'    # dir where mseed/SAC files are located
#DATADIR = '/mnt/data0/seattle_broadbands_2019/DATA_7nodes_resp_removed'
...
#respdir   = os.path.join(rootpath,'RESP/MERI_spectrum')                               # directory where resp files are located (required if rm_resp is neither 'no' nor 'inv')
...
for ick in range(rank,splits,size):
    ...
    for ista in range(nsta):
        ...
        #for ifile in tfiles:
            ...
            #print("file is "+str(ifile)) # natasha
