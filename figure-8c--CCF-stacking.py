...
rootpath = '/mnt/data1/SEATTLE_June-2021_studies' # root path for this data processing
CCFDIR = os.path.join(rootpath,'CCFs-S1-output_40-Hz_one-bit_july-2022') # dir where CC data is stored
STACKDIR = os.path.join(rootpath,'STACK_CCFs--S2-output_one-bit--August-2022--rotated-RTZ--Feb-2023') # dir where stacked data is going to
...
for ipair in range (rank,splits,size):
    ...
    for icomp in range(nccomp):
        ...
        # keep track of all sub-stacked data from S1
        if keep_substack:
